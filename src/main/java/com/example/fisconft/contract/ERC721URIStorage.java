...
public class ERC721URIStorage extends Contract {
    ...
    protected ERC721URIStorage(String contractAddress, Client client, CryptoKeyPair credential) {
    ...
    public static ERC721URIStorage load(String contractAddress, Client client, CryptoKeyPair credential) {
        return new ERC721URIStorage(contractAddress, client, credential);
    }

    public static ERC721URIStorage deploy(Client client, CryptoKeyPair credential) throws ContractException {
        return deploy(ERC721URIStorage.class, client, credential, getBinary(client.getCryptoSuite()), "");
    }
