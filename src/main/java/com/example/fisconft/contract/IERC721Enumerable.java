...
public class IERC721Enumerable extends Contract {
    ...
    protected IERC721Enumerable(String contractAddress, Client client, CryptoKeyPair credential) {
    ...
    public static IERC721Enumerable load(String contractAddress, Client client, CryptoKeyPair credential) {
        return new IERC721Enumerable(contractAddress, client, credential);
    }

    public static IERC721Enumerable deploy(Client client, CryptoKeyPair credential) throws ContractException {
        return deploy(IERC721Enumerable.class, client, credential, getBinary(client.getCryptoSuite()), "");
    }
