...
public class IERC721Metadata extends Contract {
    ...
    protected IERC721Metadata(String contractAddress, Client client, CryptoKeyPair credential) {
    ...
    public static IERC721Metadata load(String contractAddress, Client client, CryptoKeyPair credential) {
        return new IERC721Metadata(contractAddress, client, credential);
    }

    public static IERC721Metadata deploy(Client client, CryptoKeyPair credential) throws ContractException {
        return deploy(IERC721Metadata.class, client, credential, getBinary(client.getCryptoSuite()), "");
    }
